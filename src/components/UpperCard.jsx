  ...
  useEffect(() => {
    switch (title) {
      ...
      case "Support & Resistance":
        switch (currentTime) {
          case "5min":
            setPointerLocation(150);
            break;
          case "10min":
            setPointerLocation(200);
            break;
          case "15min":
            setPointerLocation(70);
            break;
          case "30min":
            setPointerLocation(175);
            break;
          case "1hr":
            setPointerLocation(110);
            break;
          default:
            setPointerLocation(132);
            break;
        }
        break;
    }
    ...
    <div className="p-3 flex flex-col gap-8 w-[500px] bg-white shadow-md sm:ml-5 mb-5 lg:mb-0">
      ...
      <div className="relative flex justify-center items-center">
        ...
        <img
          ...
          className="w-4 absolute transition-all duration-500 ease-in-out"
